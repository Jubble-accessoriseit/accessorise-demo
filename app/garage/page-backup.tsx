...
export default function GaragePage() {
  ...
  const heroImage = uploadedPhotos[selectedPhotoIndex]?.url || selectedBike.heroImage;
      ...
      if (isSignedIn) {
        ...
        const uploaded = await Promise.all(
          acceptedFiles.map((file, index) =>
            uploadBuildPhoto(file, startSortOrder + index)
          )
        );
              ...
              <>
                ...
                >
                  {uploadedPhotos.map((photo, index) => {
                    ...
                    return (
                      <div key={photo.id} style={{ minWidth: 120, width: 120 }}>
                        <button
          ...
          >
            ...
            >
              ...
              >
                ...
                <div style={{ fontWeight: 700, marginTop: 4 }}>{selectedBike.brand}</div>
              </div>
              ...
              >
                ...
                <div style={{ fontWeight: 700, marginTop: 4 }}>{selectedBike.model}</div>
              </div>
              ...
              >
                ...
                <div style={{ fontWeight: 700, marginTop: 4 }}>{selectedBike.yearLabel}</div>
              </div>

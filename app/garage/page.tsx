...
{activeStep === "Bike" && (
  <GarageBikeStep
    ...
    onOpenGarageBuildInWorkspace={handleOpenGarageBuildInWorkspace}
    onSelectMake={(value) => {
    ...
    {isCheckingSession ? (
      ...
      >
        ...
        <MyGarageStep
          ...
          onDeleteBuildPhoto={handleDeleteGarageBuildPhoto}
...
{activeStep === "Buy" && (
  <GarageShopStep
    ...
    buySelectedBike={buySelectedBike}
    ...
    getCompatibilityLabel={getCompatibilityLabel}
    getGarageBikeDisplayName={getGarageBikeDisplayName}
    getProductSupplierName={getProductSupplierName}
    isPhone={isPhone}
    myGarageBikes={myGarageBikes}
    onAddProductToBikeBuild={addProductToBikeBuild}
    onBackToResults={() => {
      setActiveProductDetail(null);
      setActivePurchaseState(null);
    }}
    onChangeSelectedBike={(bikeId) => {
      setBuySelectedBikeId(bikeId);
      setActivePurchaseState(null);
      setActiveProductDetail(null);
    }}
